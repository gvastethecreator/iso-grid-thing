...
import { Palette, Baseline, Frame, PenLine, PaintBucket, Square, LayoutGrid, Contrast, Expand, GripHorizontal } from 'lucide-react';
...
const StylingPanel: React.FC<StylingPanelProps> = ({ params, onParamChange, onParamChangeEphemeral, onInteractionStart }) => {
    ...
    return (
        <FloatingPanel title="Styling" icon={<Palette size={15} />}>
            ...
            <Toggle 
                ...
                onChange={enabled => { onParamChange({ fillEnabled: enabled }); }} 
            />
            ...
            <Toggle 
                ...
                onChange={enabled => { handleBgGridChange({ enabled }); }} 
            />
